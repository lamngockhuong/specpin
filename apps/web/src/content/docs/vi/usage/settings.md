...
| `Alt+Shift+U` | Bật/tắt dấu coverage trên các phần tử chưa có tài liệu |
...
Không nhớ phím tắt? Nhấn `Alt+Shift+?` trên bất kỳ trang nào để xem bảng phím tắt chỉ đọc, hoặc mở cùng danh sách đó ở **Options -> Shortcuts**. Phím tắt luôn hoạt động. Bạn không thể đổi phím từ trang Options (dùng cài đặt phím tắt extension của trình duyệt nếu cần thay đổi).
