...
1. Trong popup hoặc side panel, mở menu **⋯ More actions** (góc trên bên phải) rồi nhấp **Xuất**. Nếu nhiều dự án phục vụ trang, menu liệt kê mỗi dự án một mục Xuất riêng.
