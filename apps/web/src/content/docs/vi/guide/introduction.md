...
Specpin **không phải** là công cụ sinh mã từ spec. Nó không liên quan gì đến GitHub Spec Kit / OpenSpec. Nó không sinh ra bất kỳ mã ứng dụng nào. Nó là một lớp kiến thức ghim tài liệu sống lên giao diện bạn đã có.
