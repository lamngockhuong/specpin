...
ツールバーのSpecpin extensionアイコンをクリックします。**このページのspecを表示**スイッチをONにしてください。

### 5. sidecarに接続する

extension popupで**接続設定**の歯車アイコン（右上）をクリックし、**プロジェクトを追加**をクリックします。
