...
<p align="center">
  ...
  <a href="https://addons.mozilla.org/ja/firefox/addon/specpin/">
    <img src="https://img.shields.io/badge/インストール-Firefox_Add--ons-FF7139?style=for-the-badge&logo=firefox&logoColor=white" alt="Firefox Add-onsからインストール">
  </a>
</p>
...
Firefoxユーザーは**[Firefox Add-ons](https://addons.mozilla.org/ja/firefox/addon/specpin/)**からインストールできます。（ソースからビルドしてunpackedで読み込むこともできます — [実行ガイド](./docs/run-guide.md)を参照。）
...
#    Firefox: Firefox Add-onsからインストール（上記リンク）
```
...
Specpinはリリース済みで、[Chrome Web Store](https://chromewebstore.google.com/detail/specpin/kkfmoieoahdjneagognaoedggkiiolkn)と[Firefox Add-ons](https://addons.mozilla.org/ja/firefox/addon/specpin/)の両方で公開中です。開発は継続中です。出荷済みの機能・予定・意思決定ログは[`docs/project-roadmap.md`](./docs/project-roadmap.md)を参照してください。
