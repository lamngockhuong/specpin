...
im lặng và đánh dấu spec "mồ côi" thay vì đoán sai.
...
làm. Hãy re-pin vài spec mồ côi trước (mở trang, gắn spec vào đúng phần tử), rồi
export lại.

## Từng bước

1. Trong Options của extension, bật thẻ **Matching corpus**.
2. Dùng app như bình thường. Khi spec bị mồ côi sau một thay đổi giao diện, hãy
