...
- Chỉ dữ liệu soạn tay ở v1 (chưa có editor trong extension cho flows/screens); demo app có sẵn ví dụ hoàn chỉnh tại `examples/demo-react-app/.specs/flows.json` và `screens.json`.
