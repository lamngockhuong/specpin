...
- Manual-authored data only in v1 (no in-extension editor for flows/screens yet); the demo app ships worked examples at `examples/demo-react-app/.specs/flows.json` and `screens.json`.
